  ...
  return (
    <div className={active || pathname !== "/" ? "navbar active" : "navbar"}>
      <div className="container">
        ...
        <div className="links">
          <span>LocalLens Business</span>
          <span>Explore</span>

          {currentUser ? (
            <div className="user" onClick={() => setOpen(!open)} style={{ position: "relative" }}>
              ...
              {open && (
                <div className="options">
                  ...
                  {/* Buyer / non-seller links */}
                  {!currentUser.isSeller && currentUser.role !== "admin" && (
                    <Link className="link" to="/complaint/new">Submit Complaint</Link>
                  )}

                  {/* Admin links */}
                  {currentUser.role === "admin" && (
                    <>
                      <Link className="link" to="/admin/complaints">Admin Complaint Dashboard</Link>
                      <Link className="link" to="/admin/complaints/list">Complaint List</Link>
                    </>
                  )}
